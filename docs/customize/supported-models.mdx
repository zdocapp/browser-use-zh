...
- Balanced: fast + cheap + clever: `gemini-2.5-flash`

Find full examples built for you in github [examples/models](https://github.com/browser-use/browser-use/tree/main/examples/models).
